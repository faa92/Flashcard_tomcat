        ...
        <c:if test="${!themes.isEmpty()}">
            <ul>
                <c:forEach var="theme" items="${themes}">
                    <li>
                        <a href="<c:url value="/cards?themeId=${theme.idTheme}"/>">
                        ...
                        <form action="<c:url value="/remove-theme"/>"
                            ...
                            <button type="submit" name="themeId" value="${theme.idTheme}">Удалить</button>
                        </form>
                    </li>
                </c:forEach>
            </ul>
...
<%--                            <c:out value="${theme.title}"/>--%>
<%--                        </a>--%>
<%--                            ${theme.getLearnedCardsCount()} / ${theme.getTotalCardsCount()}--%>
<%--                        <form action="<c:url value='/remove-theme'/>"--%>
<%--                              method="post"--%>
<%--                              enctype="application/x-www-form-urlencoded">--%>
